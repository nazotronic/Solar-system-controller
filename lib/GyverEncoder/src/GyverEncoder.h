...
public:
    ...
    boolean isRight(bool keepFlag = false);// возвращает true при повороте направо, сама сбрасывается в false
    boolean isLeft(bool keepFlag = false);	// возвращает true при повороте налево, сама сбрасывается в false
    boolean isRightH(bool keepFlag = false);// возвращает true при удержании кнопки и повороте направо, сама сбрасывается в false
    boolean isLeftH(bool keepFlag = false);	// возвращает true при удержании кнопки и повороте налево, сама сбрасывается в false
